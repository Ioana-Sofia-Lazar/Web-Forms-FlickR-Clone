...
<div class="about-container">
    ...
    <p id="userDescription" runat="server" class="about-description"></p>
    ...
    <strong>
    <p id="userOccupation" runat="server"></p>
    <p id="userCountry" runat="server"></p>
    <p id="userWebsite" runat="server"></p>
    </strong>
    </div>
  </div>
</asp:Content>
